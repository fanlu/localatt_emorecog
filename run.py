...
train_utt_lab_path    = p['dataset']+'/wav_cat_train.list'
dev_utt_lab_path      = p['dataset']+'/wav_cat_dev.list'
eval_utt_lab_path      = p['dataset']+'/wav_cat_test.list'
...
#trainset = lld_dataset3(train_utt_lab_path, cls_wgt)
#devset = lld_dataset3(dev_utt_lab_path, cls_wgt)
#evalset = lld_dataset3(eval_utt_lab_path, cls_wgt)

_collate_fn = lld_collate_fn(device=device) # done.
trainloader = DataLoader(trainset, bsz, collate_fn=_collate_fn, shuffle=True)
